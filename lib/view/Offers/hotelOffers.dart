...
class _HotelOffersState extends State<HotelOffers> {
  ...
  return provider.Offers.isNotEmpty ? ListView.builder(
              ...
              return Stack(
                ...
                children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    Expanded(
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(" ${provider.Offers[index]['type']}",
                                                style: TextStyle(
                                ...
                                Text(
                                  "Start Date".tr + ": ${provider.Offers[index]['startDate']}" "\n" "End Date".tr + ": ${provider.Offers[index]['endDate']}",
                                  style: TextStyle(
                                ...
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Text(
                                          "Old Price".tr + ": ${provider.Offers[index]['price']}",
                                          style: TextStyle(
                                              color:  Colors.black,
                                              fontWeight: FontWeight.bold),
                                        ),
                                    ...
                                    Text(
                                      "Offer Price".tr + ": ${provider.Offers[index]['newPrice']}",
                                      style: TextStyle(
                                          color: Colors.black,
                                          fontWeight: FontWeight.bold),
                                    ),
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          "Room Numper".tr + ": ${provider.Offers[index]['roomNumber']}",
                                          style: TextStyle(
                                              color: Color(0xff4C4DDC),
                                              fontWeight: FontWeight.bold),
                                        ),

                                        Text("-${(provider.Offers[index]['discount']).toStringAsFixed(2)}%",style:TextStyle(color: Color(0xff4C4DDC) ,fontWeight: FontWeight.bold),),
                                      ],
                                    ),
                                  ],
                                )
                  ...
                  Padding(
                    ...
                    child: IconButton(
                      onPressed: () async {
                        Provider.of<MyOffersProvider>(context , listen: false).deleteoffr(index);
                            },
