...
class _UserHomeScreenState extends State<UserHomeScreen> {
                      ...
                      itemBuilder: (context, index) {
                        return Stack(
                          ...
                          children: [
                            GestureDetector(
                              onTap: () async {
                                await GetHotel(context).getHotel((allhotelprovider.data?[index].userId).toString(),"Hotel${index}",index,int.parse((allhotelprovider.data?[index].rate).toString()),allhotelprovider.data?[index].userId == 3 ? true : false);
                              },
                              child: Container(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                              fit: BoxFit.cover,
                                              image: allhotelprovider.data?[index].imageId == 2
                                                  ? AssetImage("images/2.jpeg") :
                                              allhotelprovider.data?[index].imageId == 3 ?
                                ...
                                child: IconButton(
                                    onPressed: () async {
                                      if(allhotelprovider.data?[index].isFav==false){
                                        await FavouriteAPIs(context).addFavourite(index);
                                      }else{
  ...
  return allHotelProvider.data != null ?Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return allHotelProvider.data![index].isOffer==true?
                    GestureDetector(
                      onTap: ()async {
                        await GetHotel(context).getHotel((allHotelProvider.data?[index].userId).toString(), "Hotel$index""pop",index,int.parse((allHotelProvider.data?[index].rate).toString()),allHotelProvider.data?[index].userId == 3 ? true : false);
                      },
                      child: Container(
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.all(Radius.circular(6)),
