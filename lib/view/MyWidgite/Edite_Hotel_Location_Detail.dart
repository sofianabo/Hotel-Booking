...
import 'package:provider/provider.dart';
  ...
  detailLocation(BuildContext context , String det) {
                    ...
                    children: [
                      ...
                      TextButtonforHotel(onpressed: () async {
                         if(  detailcon.text.isNotEmpty){
                           Provider.of<HotelRoomsProvider>(context , listen: false).setlocationdetail(detailcon.text);
                           Provider.of<DraweProvider>(context , listen: false).opendrawer(false);
                           showSnackBar(context, "Done Editing Location Detail", Colors.green, false);
                        ...
                        hight: 60,
                        text: "Update Location Detail".tr ,
