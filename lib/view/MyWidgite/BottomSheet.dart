               ...
               children: [
                 ...
                 Padding(
                   ...
                   child: TextButton(
                     ...
                     child: Text("${Provider.of<DateProvider>(context , listen: false).Dateis} Days"),
                     style: ButtonStyle(
                 ...
                 Padding(
                   ...
                   child: Hero(
                     ...
                     child: TextButton(
                        onPressed: ()async {
                      await RoomTotalAPI(context).RoomTotal(int.parse((Provider.of<DateProvider>(context , listen: false).Dateis).toString()),Provider.of<SelectRoomsProvider>(context,listen: false).roomid!);
                         },
