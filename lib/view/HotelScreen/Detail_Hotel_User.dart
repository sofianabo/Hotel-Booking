                      ...
                      Consumer<allHotelProvider>(
                        builder: (context, allhotelprovider, child) {
                          return Hero(
                            ...
                            child: IconButton(
                              onPressed: () async {
                                if (allhotelprovider.data?[index].isFav ==
                                    false) {
                                  await FavouriteAPIs(context).addFavourite(
                                      index,
                                      );
                                } else {
                                  await FavouriteAPIs(context)
                                      .DeleteFavourite(
                                      index,
                                      );
                                }
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                    Provider.of<HotelRoomsProvider>(context,
                                                    listen: false)
                                                .rate! ==
                                            null
                                        ? "0.0"
                          ...
                          Row(
                            ...
                            children: [
                              GestureDetector(
                                  onTap: () async {
                                    Provider.of<SetRateProvider>(context,
                                            listen: false)
                                        .setrate(1);
                                  },
                                  child: Icon(
                                    Icons.star,
                                    color: Provider.of<SetRateProvider>(context,
                                                    listen: false)
                                                .rate >=
                                            1
                                        ? Color(0xffFFD33C)
                              ...
                              Padding(
                                ...
                                child: Text(
                                  Provider.of<SetRateProvider>(context,
                                          ...
                                          0
                                      ? "0"
                                      : "(${Provider.of<SetRateProvider>(context, listen: false).rate})",
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                            "${Provider.of<HotelRoomsProvider>(context, listen: false).name}",
                            style: TextStyle(fontWeight: FontWeight.bold)),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Text(
                                "SP".tr +
                                    "${Provider.of<HotelRoomsProvider>(context, listen: false).minPrice}",
                                style: TextStyle(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            "${Provider.of<HotelRoomsProvider>(context, listen: false).country}"
                            " - ${Provider.of<HotelRoomsProvider>(context, listen: false).city}",
                            style: TextStyle(
                      ...
                      Provider.of<HotelRoomsProvider>(context, listen: false)
                          ...
                          ? Column(
                              children: [
                                Text(
                                  "Start Offer Date".tr +
                                      " ${Provider.of<HotelRoomsProvider>(context, listen: false).StartDate}",
                                  style: TextStyle(
                                      color: Color(0xff4C4DDC),
                                      fontWeight: FontWeight.bold),
                                ),
                                Text(
                                  "End Offer Date".tr +
                                      " ${Provider.of<HotelRoomsProvider>(context, listen: false).EndDate}",
                                  style: TextStyle(
                                      color: Color(0xff878787),
                                      fontWeight: FontWeight.bold),
                                )
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      borderRadius:
                                          BorderRadius.all(Radius.circular(6)),
                                      image: DecorationImage(
                                          image: AssetImage("images/priv1.jpg"),   fit: BoxFit.cover)),
                                ),
                              ),
                            ),
                            GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      borderRadius:
                                          BorderRadius.all(Radius.circular(6)),
                                      image: DecorationImage(
                                          image: AssetImage("images/priv12.jpg"),   fit: BoxFit.cover)),
                                ),
                              ),
                            ),
                            GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      borderRadius:
                                          BorderRadius.all(Radius.circular(6)),
                                      image: DecorationImage(
                                          image: AssetImage("images/priv13.jpg"),   fit: BoxFit.cover)),
                                ),
                              ),
                            )
                          ],
